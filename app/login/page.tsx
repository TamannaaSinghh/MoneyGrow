    ...
    <>
      ...
      <Section>
        <div className="grid md:grid-cols-2 gap-8">
          ...
          >
            <p className="font-mono text-xs text-teal-600 tabular">/PMS</p>
            ...
            <span className="mt-8 inline-flex items-center gap-2 text-sm font-medium text-teal-600 group-hover:translate-x-1 transition-transform">
              Open Wealthspectrum →
            </span>
        ...
        <p className="mt-12 text-xs text-ink/50 max-w-2xl leading-relaxed">
